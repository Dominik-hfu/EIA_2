...
(function (AlpenFlug) {
    ...
    function handleload(_event) {
        ...
        let parachutist = new AlpenFlug.Parachutist("Paragleiter", [0, 0], [1, 1], "blue", [2, 2]); // Typfehler???
        parachutist1.draw();
    ...
    function update() {
        AlpenFlug.crc2.getImageData(0, 0, canvas.width, canvas.height);
        // parachutist.draw();???
        // bumblebee.draw();???
    }
    ...
    let parachutist1 = new AlpenFlug.Parachutist("Parachutist", randomPosition, [50, 30], "yellow", [1, 2]); //Jirkas code?
